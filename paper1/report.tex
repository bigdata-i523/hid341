...
Another area that falls into the big data applications aspec for clinical trials is is Clinical Trial Management System (CTMS), this is a software which the sponsor can use  
