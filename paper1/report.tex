...
The screen visit will assess for these parameters and the data collected, which is electronically captured can be reviewed by clinican; in order to determine if the scores and history of the subject meet the inclusive criteria into the study or if the subject falls into the exclusive criteria and should not be included in the study. Because electronic data caputure systems store subject data for each visit throught out study, granted the subject does not drop out of the study, sponsors, CROs, and vendors can use this as a tracking system for progress towards the result they are looking to accomplish (end point reliabilty). Working together, clinicians, data managers and data anaylists can access and extract data from EDCs in form CVS files or execel sheets to review and analyzie the data. Here Data anaylist and maybe data scientist can use R or Python to invesitage the data and create reports for the sponsors on the performance of the raters during the subject visits, or a trend over time in score responses of the subject visits such as are the scores showing improvement during the course of the study, or are they the same, or getting worse, etc.  in  that offer end point relabilty  
