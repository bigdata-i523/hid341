...
Next the R code is displayed as 
\begin{document}
<<echo=FALSE>>=
library(knitr)
library(ggplot2)
...
This bar graph (Graph 4) shows how many women and men boarded the Titanic. As one can see there were more men than women that were on the Titanic based on the data set that was provided from Kraggle
